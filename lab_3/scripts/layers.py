...
def batchnorm_forward(x, gamma, beta, bn_param):
    ...
    if mode == "train":
        ...
        # Compute mean and variance for the current minibatch
        ...
        # Use running mean and variance for normalization at test time
...
def batchnorm_backward(dout, cache):
    ...
    # Gradients w.r.t. scale and shift parameters are straightforward
      ...
      for f in range(F):
        for i in range(H_out):
          ...
          for j in range(W_out):
            ...
            dw[f] += window * dout_val
            dx_padded[n, :, h_start:h_end, w_start:w_end] += w[f] * dout_val
